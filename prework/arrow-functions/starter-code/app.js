...
// let theNewWay = (course) => {  `I am currently enrolled in ${course}`;}
// console.log('The new way:', theNewWay('Code 301'));

// let withoutParens = course => {`I am currently enrolled in ${course}`;}
// console.log('Without parens:', withoutParens('Code 301'));
...
// let addOneLiner = (num1, num2) => `${num1} + ${num2} = ${num1 + num2}`;
// console.log('Add as a one-liner:', addOneLiner(4, 5));

// let multiLiner = word => {word = word.toUpperCase(); word;}
// console.log('Multi-line arrow function:', multiLiner('hello'));

// let oldObject =  (array) => ({firstValue: array[0],secondValue: array[1],thirdValue: array[2] });
// console.log('Hello from the old object function', oldObject(['hi', 'hello', 'are you there?']));

// let newObject = array => ({firstValue: array[0], secondValue: array[1], thirdValue: array[2] });
// console.log('Hello from the new object function', newObject(['hi', 'hello', 'are you there?']));
